...
/**
 * Servlet implementation class Ex11
 */
@WebServlet("/Ex11")
public class Ex11 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "1":
			...
			result = p1.play(request, response);
			break;
		case "2":
			Play02 p2 = new Play02();
			result = p2.play(request, response);
			break;
		case "3": 
			Play03 p3 = new Play03();
			result = p3.play(request, response);
			break;	
		case "4":
			Play04 p4 = new Play04();
			result = p4.play(request, response);
			break;
		}
		*/
		...
		// 차후에 jsp를 배우면 html, jsp문서로 넘겨서 출력할 수 있다.
	}
